...
with left_col:
    ...
    with col1:
        ...
        time_cost_rate= st.slider("Time to Cost Rate ($/hour)", 0, 50, 25)
    ...
    ua = UberAll(time_cost_rate, neighborhoods['distance_to_berryessa_miles'])
    ub = UberBartMix(time_cost_rate, neighborhoods['distance_to_berryessa_miles'], safety_cost)
    ...
    neighborhoods['cost_drive'] = Drive(time_cost_rate, inconvenience_fee).get_cost(hour_of_day, is_weekday)
...
st.markdown("- For more details, see [Written Report](https://docs.google.com/document/d/1ufr4oLwcIxWtQ4pYIvVG1Ovlq07B3Hdzpc68Vi2L9Cw/edit?usp=sharing).", unsafe_allow_html=True)
